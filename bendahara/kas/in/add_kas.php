	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="uraian" name="uraian" placeholder="Uraian Pemasukan" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_kas (tanggal,uraian,masuk,keluar,jenis) VALUES (
        '".$_POST['tanggal']."',
        '".$_POST['uraian']."',
        '".$masuk_hasil."',
        '0',
    ...
    if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=i_add_k';
          }
      })</script>";
    }}
