<div class="card card-info">
	...
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<a href="?page=add_pengguna" class="btn btn-primary">
            ...
            ?>
					...
					<tr>
						...
						<td>
							<a href="?page=edit_pengguna&kode=<?php echo $data['id_pengguna']; ?>"
							 title="Ubah" class="btn btn-success btn-sm">
								<i class="fa fa-edit"></i>
							</a>
							<a href="?page=del_pengguna&kode=<?php echo $data['id_pengguna']; ?>"
